/* ============================================================
 * LyraSkeleton Step4.5 - Start / Stop / Pivot + Distance Matching + Warping (심화)
 * Step4 와 동일 구조. SECTIONS / localStorage 키만 Step4.5 전용
 * ============================================================ */
(function () {
  'use strict';
  ...
  // ----------------------------------------------------------
  const SECTIONS = [
    { num: '01', file: '01_overview.html',           title: '개요 · 본 심화 분석에서 부각된 사실', tag: '오리엔테이션' },
    { num: '02', file: '02_locomotion-states.html',  title: 'LocomotionSM 5 상태 + 13 전이 룰 노드 트리', tag: 'State Machine' },
    { num: '03', file: '03_data-pipeline.html',      title: 'ABP_Base 24 변수 + BTSUA 6 단', tag: 'AnimBP' },
    { num: '04', file: '04_transition-layers.html',  title: 'Start / Stop / Pivot 콜백 + 거리매칭', tag: 'Layer/DistMatch' },
    { num: '05', file: '05_layer-graphs.html',       title: '레이어 그래프 + Warping + PivotSM', tag: 'AnimGraph/Warp' },
    { num: '06', file: '06_lean-debug.html',         title: 'BS_Lean + LeanAngle + Debug', tag: 'BlendSpace/Debug' },
    { num: '07', file: '07_input-gait.html',         title: 'BP_LsCharacter + IMC + GaitSettings', tag: 'Input/CMC' },
    { num: '08', file: '08_summary-roadmap.html',    title: '종합 + 환경 + C++ + 부록', tag: 'Summary/Roadmap' },
  ];

  const LS_VISIT = 'ls_step4_5_visited';
  const LS_THEME = 'ls_step4_5_theme';
  const LS_CK    = 'ls_step4_5_checklist';
