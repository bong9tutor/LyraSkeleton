/* ============================================================
 * LyraSkeleton Step4 - 동적 강의 페이지 컨트롤러
...
(function () {
  ...
  // ----------------------------------------------------------
  const SECTIONS = [
    { num: '01', file: '01_overview.html',          title: 'Step 4 개요 · 주요 기능',      tag: '오리엔테이션' },
    { num: '02', file: '02_locomotion-states.html', title: 'LocomotionSM 상태 확장',       tag: 'State Machine' },
    { num: '03', file: '03_data-pipeline.html',     title: 'ABP_Base 데이터 파이프라인',    tag: 'AnimBP' },
    { num: '04', file: '04_transition-layers.html', title: 'Start/Stop/Pivot + 거리매칭',  tag: 'Layer/DistMatch' },
    { num: '05', file: '05_layer-graphs.html',      title: '레이어 그래프 + Warping',       tag: 'AnimGraph/Warp' },
    { num: '06', file: '06_lean-debug.html',        title: 'Lean 데이터 준비 + Debug',     tag: 'BlendSpace/Debug' },
    { num: '07', file: '07_author-comments.html',   title: '저자 코멘트 + 디버깅 기록',     tag: '의도 분석' },
    { num: '08', file: '08_step3-diff.html',        title: 'Step 3 대비 변경점',           tag: 'Diff' },
  ];

  const LS_VISIT = 'ls_step4_visited';
  const LS_THEME = 'ls_step4_theme';
  const LS_CK    = 'ls_step4_checklist';
