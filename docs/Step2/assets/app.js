/* ============================================================
 * LyraSkeleton Step2 - 동적 강의 페이지 컨트롤러
...
(function () {
  ...
  // ----------------------------------------------------------
  const SECTIONS = [
    { num: '01', file: '01_overview.html',       title: 'Step 2 개요',            tag: '오리엔테이션' },
    { num: '02', file: '02_gait-model.html',     title: 'Gait 데이터 모델',        tag: 'Enum/Struct' },
    { num: '03', file: '03_input-flow.html',     title: '입력과 통신 흐름',        tag: 'Input/BPI' },
    { num: '04', file: '04_locomotion-sm.html',  title: 'Locomotion 스테이트 머신', tag: 'AnimBP' },
    { num: '05', file: '05_step1-diff.html',     title: 'Step 1 대비 변경점',      tag: 'Diff' },
  ];

  const LS_VISIT = 'ls_step2_visited';
  const LS_THEME = 'ls_step2_theme';
  const LS_CK    = 'ls_step2_checklist';
